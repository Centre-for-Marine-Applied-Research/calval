...
#' plus/minus the specified accuracy for each variable.
#'
...
#'
#' @param tolerance A data frame with the specified accuracy for each variable.
...
#'
#' @param vr2ar_tol The tolerance for the VR2AR temperature sensors. Set
